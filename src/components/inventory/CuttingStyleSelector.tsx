...
interface CuttingStyleSelectorProps {
  value: CuttingStyleCode | '';
  onChange: (value: CuttingStyleCode | '') => void;
  placeholder?: string;
  className?: string;
}

export const CuttingStyleSelector: React.FC<CuttingStyleSelectorProps> = ({
  value,
  onChange,
  ...
  // Create options from CUTTING_STYLES
  const options = useMemo(() => {
    return Object.entries(CUTTING_STYLES).map(([code, name]) => ({
